...
class NextDayAdapter(private val mContext: Context, private val items: List<ModelNextDay>) : RecyclerView.Adapter<NextDayAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.txt_day.text = data.nameDate
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var cardView: CardView = itemView.nextday_cardview
        var txt_day: TextView = itemView.txt_day
